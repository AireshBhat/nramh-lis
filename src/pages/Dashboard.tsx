...
export default function Dashboard() {
  ...
  const kpiMetrics = [
    ...
    { label: 'Active Machines', value: 1, icon: <Flask className="h-6 w-6 text-secondary-600" />, change: '+1' },
    { label: 'Pending Uploads', value: 10, icon: <Upload className="h-6 w-6 text-warning-600" />, change: '+3' },
