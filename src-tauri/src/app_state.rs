...
impl<R: Runtime> AppState<R> {
    ...
    pub fn new(
        ...
        let (event_sender, event_receiver) = mpsc::channel::<crate::services::autoquant_meril::MerilEvent>(100);
    ...
    async fn handle_meril_events(
        ...
        while let Some(event) = event_receiver.recv().await {
            match event {
                crate::services::autoquant_meril::MerilEvent::AnalyzerConnected { analyzer_id, remote_addr, timestamp } => {
                ...
                crate::services::autoquant_meril::MerilEvent::AnalyzerDisconnected { analyzer_id, timestamp } => {
                ...
                crate::services::autoquant_meril::MerilEvent::AstmMessageReceived { analyzer_id, message_type, raw_data, timestamp } => {
                ...
                crate::services::autoquant_meril::MerilEvent::Error { analyzer_id, error, timestamp } => {
